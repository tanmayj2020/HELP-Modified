...
def get_parser():
    ...
    # Parser class for argument parsing 
    ...
    parser.add_argument('--meta_train_devices', type=str2list, 
                default='1080ti_1,1080ti_32,1080ti_64,silver_4114,silver_4210r,samsung_a50,pixel3,essential_ph_1,samsung_s7')
    parser.add_argument('--meta_valid_devices', type=str2list, 
                default='titanx_1,titanx_32,gold_6240')
    parser.add_argument('--num_inner_tasks', type=int, default=8, help="the number of meta-batch")
    parser.add_argument('--num_meta_train_sample', type=int, default=4000, help="the number of samples for each device in meta-training pool")
